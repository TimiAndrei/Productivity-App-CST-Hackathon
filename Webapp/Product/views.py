...
def addtask(request, username=None):
    ...
    if (request.method == 'POST'):
        ...
        if form.is_valid():
            ...
            username = form.cleaned_data['username']
            new_task = task(title, description, visibility,
                            difficulty, deadline, task_type)
            ...
            messages.error(
                request, 'The form is not valid, fill the form correctly !')
